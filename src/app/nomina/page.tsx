      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-zinc-100 bg-zinc-50 p-6 rounded-b-2xl">
          <div className="rounded-xl bg-white border border-zinc-200 p-4">
            ...
            <p className="mt-1 text-2xl font-bold text-indigo-700 tabular-nums">{formatRD(nomina.salarioNeto, 0)}</p>
          </div>
  ...
  return (
    <div className="flex flex-col overflow-hidden h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-100 bg-zinc-50 text-left">
                  ...
                  <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 bg-indigo-50">S. Neto</th>
              ...
              <tbody className="divide-y divide-zinc-50">
                {nominas.map(({ empleado, resultado }) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 text-right tabular-nums font-bold text-indigo-700 bg-indigo-50/60">
        ...
        {/* Nota legal */}
        <div className="rounded-xl border border-indigo-100 bg-indigo-50 px-5 py-3.5">
          <div className="flex items-start gap-3">
            <Info className="mt-0.5 h-4 w-4 text-indigo-500 shrink-0" />
