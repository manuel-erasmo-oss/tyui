  ...
  return (
    <div className="flex flex-col overflow-hidden h-full">
      <Header
        ...
        actions={
          <button className="flex items-center gap-2 rounded-lg bg-indigo-600 px-3.5 py-2 text-sm font-medium text-white hover:bg-indigo-700 transition-colors">
        ...
        <div className="flex items-center gap-3 border-b border-zinc-200 bg-white px-6 py-3">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-200 bg-zinc-50 py-2 pl-9 pr-3 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"
            />
          </div>
          <select
            value={departamento}
            onChange={e => setDepartamento(e.target.value)}
            className="rounded-lg border border-zinc-200 bg-white py-2 pl-3 pr-8 text-sm text-zinc-700 focus:border-indigo-400 focus:outline-none"
          >
            {departamentos.map(d => (
                  ...
                  >
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        <div
                          className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold ${emp.activo ? 'bg-indigo-100 text-indigo-700' : 'bg-zinc-100 text-zinc-500'}`}
                        >
