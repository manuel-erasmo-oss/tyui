      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5 bg-zinc-50 dark:bg-[#0d0f1a]">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-zinc-200 dark:border-[#252840] bg-white dark:bg-[#141722] px-4 py-3 shadow-sm dark:shadow-none">
          ...
          <select
            ...
            className="rounded-lg border border-zinc-200 dark:border-[#252840] bg-zinc-50 dark:bg-[#1a1d2e] px-3 py-1.5 text-sm text-zinc-800 dark:text-zinc-200 focus:border-[#1B2980] dark:focus:border-indigo-500 focus:outline-none"
          >
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-[#252840] bg-white dark:bg-[#141722] shadow-sm dark:shadow-none">
          <div className="flex border-b border-zinc-100 dark:border-[#1d2035]">
            {TABS.map(t => (
              <button
                key={t.id}
                onClick={() => setTab(t.id)}
                className={`flex items-center gap-2 px-5 py-3.5 text-sm font-medium transition-colors border-b-2 ${
                  tab === t.id
                    ? 'border-[#1B2980] dark:border-indigo-500 text-[#1B2980] dark:text-indigo-400'
          ...
          {tab === 'tss' && (
            <div>
              <div className="border-b border-zinc-100 dark:border-[#1d2035] bg-zinc-50 dark:bg-[#1a1d2e] px-5 py-3 flex items-center justify-between">
                <div>
                  <p className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Formulario TSS — Nómina Mensual</p>
                  <p className="text-[11px] text-zinc-500 dark:text-zinc-400">Para remisión a la Tesorería de la Seguridad Social (CNSS) · Ley 87-01</p>
                </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-100 dark:border-[#1d2035] bg-zinc-50 dark:bg-[#1a1d2e] text-left">
                      ...
                      <th className="px-4 py-3 text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Cédula</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">S. Cotizable</th>
                      ...
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">AFP Empr</th>
                      ...
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">SFS Empr</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">SRL</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Total TSS</th>
                    </tr>
                  </thead>
                      ...
                      return (
                        <tr key={empleado.id} className="hover:bg-zinc-50 dark:hover:bg-[#1a1d2e] transition-colors">
                          <td className="px-5 py-3">
                            ...
                            <p className="text-[11px] text-zinc-500 dark:text-zinc-400">{empleado.cargo}</p>
                          </td>
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-zinc-200 dark:border-[#252840] bg-zinc-950 text-white font-bold">
          ...
          {tab === 'isr' && (
            <div>
              <div className="border-b border-zinc-100 dark:border-[#1d2035] bg-zinc-50 dark:bg-[#1a1d2e] px-5 py-3 flex items-center justify-between">
                <div>
                  <p className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Retención ISR — Asalariados</p>
                  <p className="text-[11px] text-zinc-500 dark:text-zinc-400">Para remisión a la DGII · Art. 309 Ley 11-92 · Vencimiento: día 10 del mes siguiente</p>
                </div>
                <Badge variant="info">Período: {periodo}</Badge>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-100 dark:border-[#1d2035] bg-zinc-50 dark:bg-[#1a1d2e] text-left">
                      <th className="px-5 py-3 text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Empleado</th>
                      <th className="px-4 py-3 text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Cédula</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Salario Bruto</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">AFP+SFS Ded.</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Base Gravable</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Base Anual</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Tramo ISR</th>
                      <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">ISR Mensual</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-zinc-50 dark:divide-[#1d2035]">
                    {nominas.map(({ empleado, resultado }) => {
                      ...
                      return (
                        <tr key={empleado.id} className="hover:bg-zinc-50 dark:hover:bg-[#1a1d2e] transition-colors">
                          ...
                          <td className="px-4 py-3 text-right tabular-nums text-zinc-500 dark:text-zinc-400 text-xs">
                          ...
                          <td className="px-4 py-3">
                            <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-medium ring-1 ring-inset ${
                              resultado.isrMensual === 0
                                ? 'bg-zinc-50 text-zinc-600 ring-zinc-200 dark:bg-[#1a1d2e] dark:text-zinc-400 dark:ring-[#252840]'
                                ...
                                ? 'bg-amber-50 text-amber-700 ring-amber-200 dark:bg-amber-950/40 dark:text-amber-400 dark:ring-amber-800/50'
                                : 'bg-rose-50 text-rose-700 ring-rose-200 dark:bg-rose-950/40 dark:text-rose-400 dark:ring-rose-800/50'
                            }`}>
                              {tramo}
                            </span>
                          </td>
                          <td className="px-4 py-3 text-right tabular-nums font-semibold text-violet-700 dark:text-violet-400">
          ...
          {tab === 'resumen' && (
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-6">
                {/* Costos empresa */}
                <div>
                  <h3 className="mb-4 text-xs font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Costo Total Empresa</h3>
                  <div className="space-y-2">
                    {[
                      { label: 'Salarios Brutos',        value: totales.bruto,       color: 'text-zinc-900 dark:text-zinc-100' },
                      { label: 'AFP Empleador (7.10%)',   value: totales.afpEmpleador, color: 'text-amber-700 dark:text-amber-400' },
                      { label: 'SFS Empleador (7.09%)',   value: totales.sfsEmpleador, color: 'text-amber-700 dark:text-amber-400' },
                      { label: 'SRL Empleador (1.10%)',   value: totales.srl,          color: 'text-amber-700 dark:text-amber-400' },
                      { label: 'Total TSS Empleador',     value: totalTSSEmpleador,    color: 'text-amber-800 dark:text-amber-300', bold: true },
                      { label: 'Provisión Regalía',       value: totales.regalia,      color: 'text-emerald-700 dark:text-emerald-400' },
                    ].map(r => (
                      <div key={r.label} className={`flex items-center justify-between py-2 ${r.bold ? 'border-t border-zinc-200 dark:border-[#252840] font-semibold' : ''}`}>
                ...
                <div>
                  <h3 className="mb-4 text-xs font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Obligaciones a Remitir</h3>
                  <div className="space-y-3">
                    <div className="rounded-xl border border-amber-200 dark:border-amber-800/40 bg-amber-50 dark:bg-amber-950/30 p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-xs font-semibold text-amber-800 dark:text-amber-300">TSS — CNSS</p>
                          <p className="text-[11px] text-amber-600 dark:text-amber-500">Ley 87-01 · Vence día 10</p>
                        </div>
                        <p className="text-lg font-bold text-amber-900 dark:text-amber-200 tabular-nums">{formatRD(totalTSS, 0)}</p>
                      </div>
                      <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                        <div className="rounded bg-white/70 dark:bg-black/20 px-2 py-1.5 text-center">
                          <p className="text-amber-600 dark:text-amber-500">Descuento empleados</p>
                          <p className="font-bold text-amber-900 dark:text-amber-300">{formatRD(totalTSSEmpleado, 0)}</p>
                        </div>
                        <div className="rounded bg-white/70 dark:bg-black/20 px-2 py-1.5 text-center">
                          <p className="text-amber-600 dark:text-amber-500">Aporte empleador</p>
                          <p className="font-bold text-amber-900 dark:text-amber-300">{formatRD(totalTSSEmpleador, 0)}</p>
                        </div>
                      </div>
                    </div>

                    <div className="rounded-xl border border-violet-200 dark:border-violet-800/40 bg-violet-50 dark:bg-violet-950/30 p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-xs font-semibold text-violet-800 dark:text-violet-300">ISR Asalariados — DGII</p>
                          <p className="text-[11px] text-violet-600 dark:text-violet-500">Ley 11-92 Art. 309 · Vence día 10</p>
                        </div>
                    ...
                    <div className="rounded-xl border border-emerald-200 dark:border-emerald-800/40 bg-emerald-50 dark:bg-emerald-950/30 p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-xs font-semibold text-emerald-800 dark:text-emerald-300">Provisión Regalía Pascual</p>
                          <p className="text-[11px] text-emerald-600 dark:text-emerald-500">Art. 219 Código de Trabajo · Vence 20 dic</p>
                        </div>
                        <p className="text-lg font-bold text-emerald-900 dark:text-emerald-200 tabular-nums">{formatRD(totales.regalia, 0)}</p>
                      </div>
              ...
              <div className="rounded-xl border border-zinc-200 dark:border-[#252840] bg-zinc-50 dark:bg-[#1a1d2e] px-5 py-4 flex items-start gap-3">
                ...
                <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  ...
                  en los portales de <strong className="text-zinc-800 dark:text-zinc-200">DGII</strong> (dgii.gov.do) y <strong className="text-zinc-800 dark:text-zinc-200">TSS</strong> (tss.gov.do).
